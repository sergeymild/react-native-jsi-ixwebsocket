...
namespace jsiWs {
    ...
    void JsiWs::installJSIBindings(std::string certPath, facebook::jsi::Object *jsObject) {
        ...
        auto connect = jsi::Function::createFromHostFunction(*runtime_,
                                                             ...
                                                             [this](jsi::Runtime &runtime,
                                                                 ...
                                                                 auto params = args[0].asObject(
                                                                         runtime);
                                                                 wsConnect(
                                                                         params.getProperty(runtime,
                                                                                            "endpoint").asString(
                                                                                 runtime).utf8(
                                                                                 runtime));
    ...
    void JsiWs::wsConnect(const std::string &endpoint) {
